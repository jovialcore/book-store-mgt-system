...
<!-- page title -->
<section class="section py-5" data-bg="faq" style="margin-top: -24px !important;">
		<div class="container">
			<div class="row">
				<div class="col-12">
					<div class="section__wrap">
						<!-- section title -->
						<h2 class="section__title text-light">FAQ</h2>
						<!-- end section title -->
...
<section class="py-5 text-light" style="background: #2B2B31;">
		<div class="container">
			<div class="row">
				<div class="col-12 col-md-6">
					<div class="faq">
						<h3 class="faq__title">How to pay for textbooks?</h3>
					...
					<div class="faq">
						<h3 class="faq__title">Who is the HoD of Ebsu Consultancy?</h3>
					...
					<div class="faq">
						<h3 class="faq__title">When was Ebsu Consultancy Established?</h3>
						<p class="faq__text">Various versions have evolved over the years, sometimes by accident, sometimes on purpose (injected humour and the like).</p>
					</div>

					<div class="faq">
						<h3 class="faq__title">Is Consultancy available in other Campuses?</h3>
					...
					<div class="faq">
						<h3 class="faq__title">When I change the quality of a textbooks, nothing happens.</h3>
				...
				<div class="col-12 col-md-6">
					<div class="faq">
						<h3 class="faq__title">Why isn't the text available?</h3>
					...
					<div class="faq">
						<h3 class="faq__title">Does Consultancy work 24 hrs?</h3>
